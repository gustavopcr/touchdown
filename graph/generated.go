...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Combination.combinations":
		if e.complexity.Combination.Combinations == nil {
			break
		}

		return e.complexity.Combination.Combinations(childComplexity), true
...
func (ec *executionContext) _Combination_combinations(ctx context.Context, field graphql.CollectedField, obj *model.Combination) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Combination_combinations(ctx, field)
	if err != nil {
		return graphql.Null
	}
...
func (ec *executionContext) fieldContext_Combination_combinations(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _Mutation_verify(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Combination)
	fc.Result = res
	return ec.marshalNCombination2ᚖgithubᚗcomᚋgustavopcrᚋtouchdownᚋgraphᚋmodelᚐCombination(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Mutation_verify(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "combinations":
				return ec.fieldContext_Combination_combinations(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type Combination", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
...
var combinationImplementors = []string{"Combination"}

func (ec *executionContext) _Combination(ctx context.Context, sel ast.SelectionSet, obj *model.Combination) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, combinationImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Combination")
		case "combinations":
			out.Values[i] = ec._Combination_combinations(ctx, field, obj)
...
func (ec *executionContext) marshalNCombination2githubᚗcomᚋgustavopcrᚋtouchdownᚋgraphᚋmodelᚐCombination(ctx context.Context, sel ast.SelectionSet, v model.Combination) graphql.Marshaler {
	return ec._Combination(ctx, sel, &v)
}

func (ec *executionContext) marshalNCombination2ᚖgithubᚗcomᚋgustavopcrᚋtouchdownᚋgraphᚋmodelᚐCombination(ctx context.Context, sel ast.SelectionSet, v *model.Combination) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
